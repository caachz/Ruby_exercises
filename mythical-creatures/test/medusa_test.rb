...
class MedusaTest < Minitest::Test
  ...
  def test_can_only_have_three_victims
    ...
    victim2 = Person.new("Shark")
    victim3 = Person.new("Hank")
    victim4 = Person.new("Osman")
  ...
  def test_if_a_fourth_victim_is_stoned_first_is_unstoned
    ...
    assert_equal "Osman", medusa.statues.last.name
    refute_equal "Perseus", medusa.statues.first.name
  end
